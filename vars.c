 ...
 */
int the_chain(data_t *info, char *buf, size_t *p)
{
	size_t j = *p;
 ...
 * Return: Void
 */
void _checkChain(data_t *info, char *buf, size_t *p, size_t i, size_t len)
{
	size_t j = *p;
 ...
 * Return: 1 if replaced, 0 otherwise
 */
int replace_variable(data_t *info)
{
	int i = 0;
	list_t *node;
